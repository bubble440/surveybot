...
def build_system_prompt() -> str:
    ...
    lines.append(
        "Pour toute question sur l'age ou la date de naissance:\n"
    ...
    lines.append(
        ...
        "EXCEPTION — RÈGLE SECTEUR (screener secteur d'activité, liste courte) :\n"
        "PRIORITÉ ABSOLUE : cette règle s'applique AVANT TOUTES LES AUTRES, y compris "
        "RÈGLE ABSOLUE DE PROGRESSION et le persona Finance/Conseil/Santé.\n"
        "Si la question demande si le répondant ou un membre de son foyer/famille/entourage "
        "travaille(nt) dans l'un des domaines/secteurs/industries d'une liste proposée "
        "(signaux : 'travaillez-vous', 'travaillez', 'travailles', 'travaillent', 'travaillent-elles', "
        "'certaines travaillent', 'votre foyer', 'foyer', 'entourage', 'secteur', 'domaine', 'industrie'), "
        ...
        "INTERDIT ABSOLU : choisir 'Santé', 'Finance', 'Publicité', 'Assurance', 'Voyage' ou tout autre "
        "secteur de la liste quand cette exception s'applique — même si le persona suggère ce secteur.\n"
        "Cette EXCEPTION bypass le selection_rule de la question : même si la question est checkbox avec selection_rule=multiple, tu ne dois sélectionner qu'une seule option : l'option exclusive négative.\n"
    )
